...
#
# Local runs default to SQLite. Docker Compose sets DB_ENGINE=postgresql on the
# web service so the same codebase uses Postgres there.
...
# User-uploaded files (e.g. avatars)
MEDIA_URL = "/media/"
...
# CORS: allow the Vite dev server (default port 5173) to call this API.
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Readers Nook API",
    "DESCRIPTION": "API documentation for the Readers Nook service.",
    "VERSION": "1.0.0",
